angular.module("Common").directive 'oldBucketMap', (F, Place, User, PlanitMarker, ClusterLocator, BasicOperators, ClickControls, QueryString, PlaceFilterer, $compile, $timeout) ->
