angular.module('Common').factory 'SearchBar', (QueryString) ->
  ...
  class SearchBar
    ...
    #   QueryString.modify(q:searchVal) if searchVal
    ...
    #     $('#search-input-field').val(QueryString.get()['q'])
    #     $('#search-teaser-field').html(QueryString.get()['q'])
